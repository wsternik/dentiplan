  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <div className="border-border rounded-md border p-3">
        <h3 className="mb-2 text-sm font-semibold">Wariant standardowy (wiele wizyt)</h3>
        ...
        <div className="border-border mt-2 flex justify-between gap-4 border-t pt-2 text-sm font-semibold">
          <span>Razem</span>
          <span>{standard?.grandTotal ? formatRange(standard.grandTotal) : formatPln(0)}</span>
        </div>
      </div>

      <div className="border-primary rounded-md border p-3">
