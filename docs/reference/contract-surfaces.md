...
- `quotes.diagnosis_note` — `text`, nullable; **admin-only** raw diagnosis note (FR-077), added by `quote-form-polish`. Never nested in `content` or exposed by the patient RPC.
