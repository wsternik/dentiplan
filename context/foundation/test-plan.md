...
| 9   | Public entry contract         | Prove the responsive static home retains its CTA and anchor destinations without horizontal overflow | #14           | e2e               | complete    | `context/changes/home-visual-system/` (`e2e/home-page.spec.ts`)                                                         |
