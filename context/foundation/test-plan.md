...
- Strategy (§1–§5) last reviewed: 2026-09-06 (risk #8 added with the tooth chart; risk #11 added with the visit-split prefill; risk #6 re-read when self-service sign-up was removed — impact unchanged, likelihood lower, and the absence of the door is now a test rather than a convention)
