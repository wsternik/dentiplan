...
| S-02 | llm-parsing-prefill               | dentystka wkleja diagnozę i formularz dostaje wstępnie wypełnione pola z parsowania LLM                                                              | S-01          | FR-011, FR-012                                                                                                                                                                                                                                                                               | ready    |
...
| S-02       | llm-parsing-prefill               | LLM pre-fills the new-quote form from pasted diagnosis text                 | yes                   | Odblokowany 2026-09-05: dostawca wybrany (Anthropic przez AI SDK, `tech-stack.md`).        |
