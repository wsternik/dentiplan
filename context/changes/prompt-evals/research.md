...
| ---------------------- | ------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| catalog-grounding      | Root canal on 14 and 36 plus an OPG                                                         | Exact teeth and catalog ids; premolar/molar morphology resolved; root canal alone is not urgent                                                                  |
...
| status-semantics       | In-plan 36, `(32?)`, and 48 explicitly outside the current plan                             | Exact status per tooth; 32 and 48 have visit 0                                                                                                                   |
| urgency-evidence       | Painful 36, painless caries 24, symptom-free root canal 16, explicitly urgent extraction 45 | Exact urgency plus `urgencyFromNote`; negation must not create urgency                                                                                           |
...
| anaesthesia-contrast   | Pair of notes: “consider anaesthesia” versus “all treatment under anaesthesia”              | Ordinary mention preserves a multi-visit, side-aware standard plan; explicit all-under-anaesthesia instruction yields one visit and a warning naming anaesthesia |
| synonyms-and-dentition | Endodontics 21, removal 48, scaling and OPG, fillings on permanent 15 and milk 55           | Synonyms map to catalog ids; permanent/milk morphology is correct; intentionally hardest case                                                                    |
