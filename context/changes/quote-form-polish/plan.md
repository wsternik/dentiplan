...
- [ ] 2.1 Apply and type-regenerate the nullable diagnosis-note migration.
- [ ] 2.2 Prove payload stripping and anonymous non-disclosure with unit and E2E tests.
- [ ] 2.3 Run unit, lint, and production-build verification.

#### Manual

- [ ] 2.4 Verify admin-only draft and approved note rendering, including empty state.
